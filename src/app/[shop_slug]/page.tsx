...
const TEXT = {
  ...
  noticeLine1: '\u203b\u53e3\u30b3\u30df\u3092\u66f8\u3044\u305f\u3049\u306b\u30af\u30fc\u30dd\u30f3\u3092\u53d6\u5f97\u3067\u304d\u307e\u3059',
  noticeLine2: '\u6295\u7a3f\u5b8c\u4e86\u5f8c\u3001\u30d6\u30e9\u30a6\u30b6\u306e\u623b\u308b\u30dc\u30bf\u30f3\u3067\u3053\u306e\u30da\u30fc\u30b8\u306b\u623b\u308a\u3001',
  noticeLine3: '\u4e0b\u306e\u30dc\u30bf\u30f3\u3092\u30bf\u30c3\u30d7\u3057\u3066\u304f\u3060\u3055\u3044',
  postedButton: '\u6295\u7a3f\u3057\u307e\u3057\u305f',
  postedButtonDisabled: '\u30de\u30a4\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022\u3022',
  infoMessage: '\u4e0a\u306e\u30dc\u30bf\u30f3\u3092\u62bf\u3057\u3066\u304b\u3089\u30bf\u30c3\u30d7\u3057\u3066\u304f\u3060\u3055\u3044',
        ...
        <div className="px-6 py-8 space-y-6">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-5 text-center">
            ...
            <p className="text-lg font-bold text-amber-800">
              {TEXT.presentLine1}<br />{TEXT.presentLine2}
            </p>
          </div>
          ...
          <a
            ...
            className="block w-full bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-medium text-base py-4 px-6 rounded-xl text-center transition-colors shadow-md"
          >
            {TEXT.googleButton}
          </a>
          ...
          {clickedReview ? (
            <Link
              href={`/${shop_slug}/select`}
              className="block w-full bg-amber-500 hover:bg-amber-600 active:bg-amber-700 text-white font-medium text-base py-4 px-6 rounded-xl text-center transition-colors shadow-md"
            >
              {TEXT.postedButton}
            </Link>
          ) : (
            <div>
              <button
                type="button"
                disabled
                className="block w-full bg-gray-300 text-gray-500 font-medium text-base py-4 px-6 rounded-xl text-center cursor-not-allowed"
              >
                {TEXT.postedButton}
              </button>
